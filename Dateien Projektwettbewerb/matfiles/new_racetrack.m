...
t_11_r=[(linspace(77.5,82.5,5))' 17.5*ones(5,1) ]; % right racetrack boundary, segment 11
t_11_l=[(linspace(77.5,82.5,5))' 22.5*ones(5,1) ]; % left racetrack boundary, segment 11
...
t_9_r=[(linspace(85,70,20))' -sqrt(7.5^2-((linspace(85,70,20))'-77.5).^2)+0]; % right racetrack boundary, segment 9
t_9_l=[(linspace(90,65,20))' -sqrt(12.5^2-((linspace(90,65,20))'-77.5).^2)+0]; % left racetrack boundary, segment 9
...
%% 
t_r=[t_1_r ; t_2_r ; t_3_r ; t_4_r ; t_5_r ; t_6_r ;t_11_r ;t_7_r ; t_8_r ; t_9_r ; t_10_r  ; t_12_r ];%; t_13_r ; t_14_r]; % stack of right racetrack boundaries
t_l=[t_1_l ; t_2_l ; t_3_l ; t_4_l ; t_5_l ; t_6_l ;t_11_l ; t_7_l ; t_8_l ; t_9_l ; t_10_l  ; t_12_l ];% ; t_13_l ; t_14_l]; % stack of left racetrack boundaries
